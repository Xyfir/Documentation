...
- **Spam Filter** (optional, enabled by default) - When enabled, Ptorx will automatically block redirects for any emails that are determined to be spam. Mail marked as spam *cannot* be viewed in any way unless **Save Mail** is enabled.
